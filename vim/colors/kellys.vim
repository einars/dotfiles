...
" changelog:
"         0.3:	2008.12.07
"				finished ada, haskell, html, lisp, pascal, python, ruby, scheme, sh, xml and vim
...
let orange = 'orange'
let white = 'white'
let yellowish='#d1c79e'
let orangish='#e3bb56'
let red='#998888'

if has("gui_running")
    " removed all the bolds
	hi Comment		guifg=#67686b	guibg=#222222	gui=none
	hi Cursor 		guifg=#222222	guibg=#e1e0e5	gui=none
	hi Constant 	guifg=#d1c79e	guibg=#222222	gui=none
	hi CursorLine		          	guibg=#303132	gui=none
	hi DiffAdd		guifg=#222222	guibg=#9ab2c8	gui=none
	hi DiffChange	guifg=#222222	guibg=#d1c79e	gui=none
	hi DiffDelete	guifg=#67686b	guibg=#222222	gui=none
	hi DiffText		guifg=#9d0e15	guibg=#d1c79e	gui=none
	hi Folded 		guifg=#222222	guibg=#67686b	gui=none
	hi MatchParen	guifg=#d1d435	guibg=#222222	gui=underline
	hi ModeMsg		guifg=#e1e0e5	guibg=#222222	gui=none
	hi Normal 		guifg=#e1e0e5	guibg=#222222	gui=none
	hi Pmenu		guifg=#222222	guibg=#9ab2c8	gui=none
	hi PmenuSel		guifg=#222222	guibg=#62acce	gui=none
	hi PmenuSbar	guifg=#222222	guibg=#222222	gui=none
	hi PmenuThumb	guifg=#222222	guibg=#62acce	gui=none
	hi PreProc		guifg=#d1d435	guibg=#222222	gui=none
	hi Search		guifg=#222222	guibg=#e1e0e5	gui=none
	hi Special		guifg=#9ab2c8	guibg=#222222	gui=none
	hi Statement	guifg=#62acce	guibg=#222222	gui=none
	hi StatusLine 	guifg=#222222	guibg=#62acce	gui=none
	hi StatusLineNC guifg=#222222	guibg=#e1e0e5	gui=none
	hi Todo 		guifg=#e1e0e5	guibg=#9d0e15	gui=none
	hi Type 		guifg=#e6ac32	guibg=#222222	gui=none
	hi Underlined	guifg=#e1e0e5	guibg=#222222	gui=underline
	hi Visual		guifg=#222222	guibg=#e1e0e5	gui=none
	hi Wildmenu		guifg=#62acce	guibg=#222222	gui=none
else
	if &t_Co == 256
...
hi Normal guifg=#7ca4c8
hi Special guifg=#e3bb56
hi Statement guifg=#7ca4c8
hi Function guifg=#7ca4c8
exec 'hi Type    guifg=' . dkblue
...
exec 'hi Folded guifg=' . '#222222' . ' guibg=' . '#888888'
exec 'hi Comment guifg=' . '#888888'

exec 'hi rubyInstanceVariable guifg=' . dkblue
exec 'hi rubyBlockParameter guifg=' . dkblue
exec 'hi rubyConstant guifg=' . dkblue
exec 'hi rubyInteger guifg=' . dkblue
exec 'hi rubyStringDelimiter guifg=' . yellowish
exec 'hi rubyGlobalVariable guifg=' . dkblue
exec 'hi rubyPseudoVariable guifg=' . dkblue
exec 'hi rubySymbol guifg=' . dkblue
exec 'hi rubyInterpolation guifg=' . orangish
exec 'hi rubyFunction guifg=' . orange
