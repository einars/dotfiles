...
hi NonText      ctermfg=248 guifg=#a8a8a8                           cterm=bold gui=none
...
hi WildMenu     ctermfg=0   guifg=#000000 ctermbg=184 guibg=#dfdf00 cterm=bold gui=none
...
hi MatchParen   ctermfg=188 guifg=orange ctermbg=68 guibg=#6c6c6c cterm=bold gui=none
...
hi Title        ctermfg=13 guifg=orange gui=underline
hi htmlH2       ctermfg=13 guifg=orange gui=None
